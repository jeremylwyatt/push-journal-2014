...
\title{\LARGE \bf Learning transferable kinematic models\\
...
\author{Marek~Kopicki,
        ...
        Rustam~Stolkin,
        Thomas~M{\"o}rwald,
Jeremy~L.~Wyatt% <-this % stops a space
\thanks{Kopicki, Stolkin, Zurek \& Wyatt are with Computer Science, University of Birmingham, UK e-mail: jlw@cs.bham.ac.uk. Kopicki, Zurek and Wyatt are joint first authors. T. M{\"o}rwald is with ACIN, TU Wien, Austria.}}
...
{Kopicki \MakeLowercase{\textit{et al.}}: Learning transferable
  kinematic models of the motions of manipulated objects}
